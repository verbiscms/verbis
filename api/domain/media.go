...
type Media struct {
	...
	Title			*string 			`db:"title" json:"title" binding:"alphanum,max=150"`
	Alt				*string 			`db:"alt" json:"alt" binding:"alphanum,max=150"`
	Description		*string 			`db:"description" json:"description" binding:"alphanum,max=500"`
