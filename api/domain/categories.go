...
type (
	...
	// individual posts.
	Category struct {
		ID          int       `sqlb:"id,skipAll" db:"id" json:"id"`
		...
		ParentID    *int      `sqlb:"parent_id" db:"parent_id" json:"parent_id" binding:"omitempty,numeric"`
		ArchiveID   *int      `sqlb:"archive_id" db:"archive_id" json:"archive_id" binding:"omitempty,numeric"`
