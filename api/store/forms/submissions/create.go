...
func (s *Store) Create(formID int, f domain.FormSubmission) error {
	...
	if err == sql.ErrNoRows {
		return &errors.Error{Code: errors.INTERNAL, Message: fmt.Sprintf("Error creating form submission with the form ID: %d", formID), Operation: op, Err: err}
	} else if err != nil {
