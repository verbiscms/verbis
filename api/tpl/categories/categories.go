...
func (ns *Namespace) getCategory(id interface{}) interface{} {
...
func (ns *Namespace) getCategoryByName(name interface{}) interface{} {
...
func (ns *Namespace) getCategoryParent(id interface{}) interface{} {
	i, err := cast.ToIntE(id)
	if err != nil {
		return nil
	}
...
// {{ end }}
func (ns *Namespace) getCategories(query map[string]interface{}) (map[string]interface{}, error) {
	p, err := http.GetTemplateParams(query)
	if err != nil {
		return nil, err
	}

	categories, total, err := ns.deps.Store.Categories.Get(p.Params)
