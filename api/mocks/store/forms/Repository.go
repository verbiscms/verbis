...
// Fields provides a mock function with given fields: id
func (_m *Repository) Fields(id int) (domain.FormFields, error) {
	ret := _m.Called(id)
...
func (_m *Repository) FindByUUID(_a0 uuid.UUID) (domain.Form, error) {
	ret := _m.Called(_a0)
