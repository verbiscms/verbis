...
// MockCacher is an autogenerated mock type for the MockCacher type
type MockCacher struct {
	mock.Mock
}

// Clear provides a mock function with given fields: ctx
func (_m *MockCacher) Clear(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *MockCacher) Delete(ctx context.Context, key interface{}) error {
...
func (_m *MockCacher) Get(ctx context.Context, key interface{}) (interface{}, error) {
	ret := _m.Called(ctx, key)
...
func (_m *MockCacher) GetType() string {
	ret := _m.Called()
...
func (_m *MockCacher) GetWithTTL(ctx context.Context, key interface{}) (interface{}, time.Duration, error) {
	ret := _m.Called(ctx, key)
...
func (_m *MockCacher) Invalidate(ctx context.Context, options store.InvalidateOptions) error {
...
func (_m *MockCacher) Set(ctx context.Context, key interface{}, value interface{}, options *store.Options) error {
