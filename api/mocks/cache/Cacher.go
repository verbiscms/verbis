...
func (_m *Cacher) Clear(ctx context.Context) error {
	ret := _m.Called(ctx)
...
func (_m *Cacher) Delete(ctx context.Context, key interface{}) error {
...
func (_m *Cacher) Get(ctx context.Context, key interface{}) (interface{}, error) {
	ret := _m.Called(ctx, key)
...
func (_m *Cacher) GetWithTTL(ctx context.Context, key interface{}) (interface{}, time.Duration, error) {
	ret := _m.Called(ctx, key)
...
func (_m *Cacher) Invalidate(ctx context.Context, options store.InvalidateOptions) error {
...
func (_m *Cacher) Set(ctx context.Context, key interface{}, value interface{}, options *store.Options) error {
